        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 table-responsive-sm">
                    ...
                    <form class="form-inline my-2 my-lg-0 pb-4 float-right" action="search.php">
                        <div class="search-box">
                            <input class="form-control mr-sm-2" autocomplete="off" type="search" name="search" placeholder="Search" aria-label="Search">
